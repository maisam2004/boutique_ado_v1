...
SECRET_KEY = 'django-insecure-8h@f%_&dfh!gkk29#!ph7l(=3ydjum2v3u1(uxemg0xs$@*y%_'
...
#to ge confirmation links to console and email
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.request',#rquiered by allauth
